...
class SmartConfig_Import(bpy.types.Operator, ImportHelper):
    ...
    def draw(self, context):
        ...
        box = layout.box()
        box.label(text = 'Import Settings :', icon='NONE')
            ...
            if chk2==0:
                ...
                with open(csvfile, 'r') as f:
                    for line in f.readlines():
                        name=line.split("\n")[0]
                        if name!="" and name not in bpy.context.preferences.addons.keys():
                            try:
